    ...
    <div class="flex-grow">
        <header class="mb-6">
            ...
            <div class="mb-3 flex items-baseline gap-1">
                <span
                    class="text-surface-900 dark:text-surface-100 text-3xl font-bold"
                >
                    {plan.price}
                </span>
                {#if plan.priceUnit}
                    <span
                        class="text-surface-600 dark:text-surface-400 text-sm font-normal"
                    >
                        {plan.priceUnit}
                    </span>
                {/if}
            ...
            <p
                class="text-surface-800 dark:text-surface-200 text-sm leading-relaxed"
            >
                {plan.description}
            </p>
        </header>
